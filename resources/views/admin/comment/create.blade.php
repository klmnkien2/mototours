...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.comment.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('tours_id', $tours, old('tours_id'), array('class'=>'form-control')) !!}
