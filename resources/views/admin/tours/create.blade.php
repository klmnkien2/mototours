...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.tours.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('riding_day', old('riding_day'), array('class'=>'form-control')) !!}
